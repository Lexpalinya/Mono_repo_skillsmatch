import { Wrench, Activity, BookOpenCheck, Users } from "lucide-react";
import { StatsCard } from "../../../utils/StatsCard";
import { useReportSkill } from "../context/useReportSkills";


export default function ReportSkillStatsCard() {
  const {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <StatsCard
        ...
        icon={BookOpenCheck}
        value={data?.total ?? 0}
        description="Total number of skills recorded in the system"
      />
      <StatsCard
        name="Active Skills"
        icon={Activity}
        value={data?.active ?? 0}
        description="Skills currently visible and in use across the platform"
      />
      <StatsCard
