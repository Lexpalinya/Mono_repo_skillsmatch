...
export default function View({
  open,
  currentRow,
}: IEducationalInstitutionCurrentRowProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={() => setOpen(null)}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Educational Institution Information</DialogTitle>
          <DialogDescription>
            Here’s a complete overview of the selected educational institution.
          </DialogDescription>
        </DialogHeader>
