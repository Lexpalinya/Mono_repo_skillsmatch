...
import { useReportCompany } from "@/modules/report-company/context/useReportCompany";
import type { IReportCompanyCurrentRowProps } from "@/modules/report-company/utils/type";

export default function View({ open, currentRow }: IReportCompanyCurrentRowProps) {
