...
export default function MajorStatsCard() {
  const {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <StatsCard
        ...
        icon={BookOpenCheck}
        value={data?.total ?? 0}
        description="Total number of majors recorded in the system"
      />
      <StatsCard
        name="Active Majors"
        icon={Activity}
        value={data?.active ?? 0}
        description="Majors currently visible and in use across the platform"
      />
      <StatsCard
